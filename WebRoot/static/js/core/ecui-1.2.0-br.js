(function(){var h=true,i=false,j=null,m=ecui={},bY=m.array={},E=m.dom={},aD=m.ext={},aG=m.string={},w=m.ui={},$=m.util={},p,t=document,N=Math.floor,q=Math.max,x=Math.min,aK=Math.round,as=parseInt,aA=navigator.userAgent,bt=t.compatMode=="CSS1Compat",u=/msie (\d+\.\d)/i.test(aA)?t.documentMode||+RegExp.$1:p,ap=/firefox\/(\d+\.\d)/i.test(aA)?+RegExp.$1:p,bv=/opera\/(\d+\.\d)/i.test(aA)?+RegExp.$1:p,cs=/(\d+\.\d)(\.\d)?\s+safari/i.test(aA)&&!/chrome/i.test(aA)?+RegExp.$1:p,b_={utf8:{getLength:function(a){return a.replace(/[\x80-\u07ff]/g,"  ").replace(/[\u0800-\uffff]/g,"   ").length},codeLength:function(a){return a>2047?3:a>127?2:1}},gbk:{getLength:function(a){return a.replace(/[\x80-\uffff]/g,"  ").length},codeLength:function(a){return a>127?2:1}}},b5={display:u<8?{get:function(b,a){return a.display=="inline"&&a.zoom==1?"inline-block":a.display},set:function(b,a){if(a=="inline-block"){a="inline";b.style.zoom=1}b.style.display=a}}:ap<3?{get:function(b,a){return a.display=="-moz-inline-box"?"inline-block":a.display},set:function(b,a){b.style.display=a=="inline-block"?"-moz-inline-box":a}}:p,opacity:u?{get:function(b,a){return /alpha\(opacity=(\d+)/.test(a.filter)?+RegExp.$1/100+"":"1"},set:function(b,a){b.style.filter=b.style.filter.replace(/alpha\([^\)]*\)/gi,"")+"alpha(opacity="+a*100+")"}}:p,"float":u?"styleFloat":"cssFloat"},J=bY.indexOf=function(f,a){for(var d=f.length;d--;)if(f[d]===a)break;return d},aX=bY.remove=function(f,a){for(var d=f.length;d--;)f[d]===a&&f.splice(d,1)},bo=E.addClass=function(b,a){b.className+=(" "+a)},T=E.children=function(b){for(var c=[],a=b.firstChild;a;a=a.nextSibling)a.nodeType==1&&c.push(a);return c},b0=E.contain=function(a,b){return a.contains?a.contains(b):!(a.compareDocumentPosition(b)&47)},y=E.create=function(a,b,c){c=t.createElement(c||"div");a&&(c.className=a);b&&(c.style.cssText=b);return c},ag=E.first=function(b){return bu(b.firstChild,"nextSibling")},s=E.getParent=u?function(b){return b.parentElement}:function(b){return b.parentNode},ah=E.getPosition=function(b){var c=0,d=0,e=t.body,f=s(e);if(u){if(!bt){a=F(e);isNaN(c=as(a.borderTopWidth))&&(c=-2);isNaN(d=as(a.borderLeftWidth))&&(d=-2)}a=b.getBoundingClientRect();c+=f.scrollTop+e.scrollTop-f.clientTop+N(a.top);d+=f.scrollLeft+e.scrollLeft-f.clientLeft+N(a.left)}else if(b==f){c=f.scrollTop+e.scrollTop;d=f.scrollLeft+e.scrollLeft}else{for(a=b;a;a=a.offsetParent){c+=a.offsetTop;d+=a.offsetLeft}if(bv||/webkit/i.test(aA)&&F(b,"position")=="absolute")c-=e.offsetTop;for(var a=s(b),g=F(b);a!=f;a=s(a),g=b){d-=a.scrollLeft;if(bv)a.tagName!="TR"&&(c-=a.scrollTop);else{b=F(a);e=ap&&b.overflow!="visible"&&g.position=="absolute"?2:1;c+=n(b.borderTopWidth)*e-a.scrollTop;d+=n(b.borderLeftWidth)*e}}}return{top:c,left:d}},F=E.getStyle=function(b,a){var c=b5[a],d=b.currentStyle||(u?b.style:getComputedStyle(b,j));return a?c&&c.get?c.get(b,d):d[c||a]:d},br=E.getText=ap?function(b){return b.textContent}:function(b){return b.innerText},co=E.insertAfter=function(b,a){var c=s(a);return c?c.insertBefore(b,a.nextSibling):K(b)},ai=E.insertBefore=function(b,a){var c=s(a);return c?c.insertBefore(b,a):K(b)},ba=E.insertHTML=function(b,a,c){if(b.insertAdjacentHTML)b.insertAdjacentHTML(a,c);else{var e=({AFTERBEGIN:"selectNodeContents",BEFOREEND:"selectNodeContents",BEFOREBEGIN:"setStartBefore",AFTEREND:"setEndAfter"})[a.toUpperCase()],d=t.createRange();d[e](b);d.collapse(a.length>9);d.insertNode(d.createContextualFragment(c))}},cp=E.last=function(b){return bu(b.lastChild,"previousSibling")},aj=E.moveElements=function(b,c,d){for(var a=b.firstChild;a;a=b){b=a.nextSibling;(d||a.nodeType==1)&&c.appendChild(a)}},cq=E.next=function(b){return bu(b.nextSibling,"nextSibling")},K=E.remove=function(b){var a=s(b);a&&a.removeChild(b);return b},bx=E.removeClass=function(b,a){var c=b.className.split(/\s+/).sort(),f=a.split(/\s+/).sort(),d=c.length,e=f.length;for(;d&&e;)c[d-1]==f[e-1]?c.splice(--d,1):c[d-1]<f[e-1]?e--:d--;b.className=c.join(" ")},ak=E.setInput=function(b,a,c){if(!b){if(u<9)return y("","",'<input type="'+(c||"")+'" name="'+(a||"")+'">');b=y("","","input")}a=a===p?b.name:a;c=c===p?b.type:c;if(b.name!=a||b.type!=c)if(u){ba(b,"AFTEREND",'<input type="'+c+'" name="'+a+'" class="'+b.className+'" style="'+b.style.cssText+'" '+(b.disabled?"disabled":"")+(b.readOnly?" readOnly":"")+">");a=b;(b=b.nextSibling).value=a.value;c=="radio"&&(b.checked=a.checked);K(a)}else{b.type=c;b.name=a}return b},by=E.setStyle=function(b,a,c){var d=b5[a];d&&d.set?d.set(b,c):b.style[d||a]=c},ct=E.setText=ap?function(b,a){b.textContent=a}:function(b,a){b.innerText=a},cn=aG.encodeHTML=function(a){return a.replace(/[&<>"']/g,function(a){return"&#"+a.charCodeAt(0)+";"})},b2=aG.getByteLength=function(a,b){return b?b_[b].getLength(a):a.length},cu=aG.sliceByte=function(a,b,c){if(c){for(var d=0,e=b_[c].codeLength;d<a.length;d++){b-=e(a.charCodeAt(d));if(b<0)return a.slice(0,d)}return a}return a.slice(0,b)},bz=aG.toCamelCase=function(a){if(a.indexOf("-")<0)return a;return a.replace(/\-./g,function(a){return a.charAt(1).toUpperCase()})},cv=aG.toHalfWidth=function(a){return a.replace(/[\u3000\uFF01-\uFF5E]/g,function(a){return String.fromCharCode(q(a.charCodeAt(0)-65248,32))})},aH=aG.trim=function(a){return a&&a.replace(/^\s+|\s+$/g,"")},S=$.attachEvent=function(a,b,c){a.attachEvent?a.attachEvent("on"+b,c):a.addEventListener(b,c,i)},P=$.blank=function(){},cw=$.cancel=function(){return i},L=$.copy=function(a,b){for(var c in b)a[c]=b[c];return a},aC=$.detachEvent=function(a,b,c){a.detachEvent?a.detachEvent("on"+b,c):a.removeEventListener(b,c,i)},aR=$.findConstructor=function(a,b){for(;a;a=a.superClass){a=a.constructor;if(a[b])return a[b]}},aF=$.getView=function(){var a=t.body,b=s(a),c=bt?b:a,e=b.scrollTop+a.scrollTop,d=b.scrollLeft+a.scrollLeft;return{top:e,right:d+c.clientWidth,bottom:e+c.clientHeight,left:d,width:c.clientWidth,height:c.clientHeight,maxWidth:q(b.scrollWidth,a.scrollWidth,c.clientWidth),maxHeight:q(b.scrollHeight,a.scrollHeight,c.clientHeight)}},l=$.inherits=function(a,b){var d=a.prototype,c=new Function();c.prototype=b.prototype;L(a.prototype=new c(),d);a.prototype.constructor=a;a.superClass=b.prototype;return a.prototype},Z=$.timer=function(a,b,c){var d=Array.prototype.slice.call(arguments,3),e=(b<0?setInterval:setTimeout)(function(){a.apply(c,d);b>=0&&(a=c=d=j)},Math.abs(b));return function(){(b<0?clearInterval:clearTimeout)(e);a=c=d=j}},n=$.toNumber=function(a){return as(a)||0},cr=E.ready=(function(){var g=i,f=[],b,c;function e(){if(!g){g=h;for(var d=0,a;a=f[d++];)a()}}t.addEventListener&&!bv?t.addEventListener("DOMContentLoaded",e,i):u&&window==top?(b=function(){try{t.documentElement.doScroll("left");e()}catch(a){Z(b,0)}}):cs&&(b=function(){var d=0,f,a=t.readyState;if(a!="loaded"&&a!="complete")Z(b,0);else{if(c===p){c=0;if(f=t.getElementsByTagName("style"))c+=f.length;if(f=t.getElementsByTagName("link"))for(;a=f[d++];)a.getAttribute("rel")=="stylesheet"&&c++}t.styleSheets.length!=c?Z(b,0):e()}});b&&b();S(window,"load",e);return function(a){g?a():f.push(a)}})(),aJ=m.NORMAL=0,a$=m.INIT=1,bB=m.PAINT=2,aY,aZ,bb,o,bA,a6,bZ,b$,a7,cm,a8,a9,Q=m.findControl=function(b){for(;b;b=s(b))if(b.getControl)return b.getControl();return j},b1,b3,aE,aS,aT,aU,b4,bp,bq,bs,aV,aW,U,bw,aq,ar,G,aQ=["mousedown","mouseover","mousemove","mouseout","mouseup","pressstart","pressover","pressmove","pressout","pressend","click","focus","blur","keydown","keypress","keyup","mousewheel","change","resize","create","init"],k=w.Control=function(b,e){this._bCapture=e.capture!==i;this._bSelect=e.select!==i;this._bFocusable=e.focus!==i;this._bEnabled=e.enabled!==i;this._sBaseClass=this._sClass=e.base;this._sUID=e.uid;this._sType=e.type;this._eBase=this._eBody=b;this._cParent=j;this._sWidth=b.style.width;this._sHeight=b.style.height;this._aStatus=[""," "];aY(b,this)},g=k.prototype,aN,bI=l(w.Label=function(b,e){k.call(this,b,e);aZ(this,this.setFor,e["for"])},k),bi=l(w.Progress=function(b,e){k.call(this,b,e);var a=b.innerHTML;b.innerHTML='<div class="'+e.base+'-text" style="position:absolute;top:0px;left:0px"></div><div class="'+e.base+'-mask" style="position:absolute;top:0px;left:0px"></div>';this._eText=b.firstChild;this._eMask=b.lastChild;this.setText(e.rate||0,a)},k),ab=l(w.Form=function(b,e){k.call(this,b,e);var a=y(e.base+"-main","position:relative;overflow:auto"),c=ag(b);aj(b,a,h);if(c&&c.tagName=="LABEL"){b.innerHTML='<div class="ec-control '+e.base+'-close" style="position:absolute"></div>';b.insertBefore(c,b.firstChild);c.className="ec-control "+c.className+" "+e.base+"-title";c.style.cssText+=";position:absolute"}else{b.innerHTML='<div class="ec-control '+e.base+'-title" style="position:absolute"></div><div class="ec-control '+e.base+'-close" style="position:absolute"></div>';c=b.firstChild}b.style.overflow="hidden";b.appendChild(a);this._bHide=e.hide;this._bAuto=e.titleAuto!==i;this._uTitle=o(w.Form.Title,c,this,{select:i});this._uClose=o(w.Form.Close,c.nextSibling,this,{select:i});this.getOuter().style.zIndex=aO.push(this)+4095},k),cd=l(w.Form.Title=function(b,e){k.call(this,b,e)},k),cc=l(w.Form.Close=function(b,e){k.call(this,b,e)},k),aO=[],aM=l(w.Collection=function(b,e){k.call(this,b,e);this._aItem=[];for(var d=0,f=T(b),a;a=f[d];)this._aItem[d++]=o(w.Collection.Item,a,this)},k),bF=l(w.Collection.Item=function(b,e){k.call(this,b,e)},k),al=l(w.Calendar=function(b,e){k.call(this,b,e);b.style.overflow="auto";for(var d=0,f=[],a=e.base;d<7;)f[d]='<div class="ec-collection-item '+a+'-name-item" style="float:left">'+["\u65e5","\u4e00","\u4e8c","\u4e09","\u56db","\u4e94","\u516d"][d++]+"</div>";f[d]='</div><div class="ec-collection '+a+'-date" style="padding:0px;border:0px">';for(;++d<50;)f[d]='<div class="ec-collection-item '+a+'-date-item" style="float:left"></div>';b.innerHTML='<div class="ec-collection '+a+'-name" style="padding:0px;border:0px">'+f.join("")+"</div>";this._uName=o(w.Collection,b.firstChild,this);this._uDate=o(w.Calendar.Date,b.lastChild,this);this.setDate(e.year,e.month)},k),ca=l(w.Calendar.Date=function(b,e){w.Collection.call(this,b,e)},w.Collection),O=l(w.Item=function(b,e){k.call(this,b,e);b.style.overflow="hidden"},k),r=w.Items={},Y=l(w.Popup=function(b,e){k.call(this,b,e);K(b);b.style.cssText+=";position:absolute;overflow:hidden";if(this._nOptionSize=e.optionSize){var a=y(e.base+"-main","position:absolute;top:0px;left:0px");aj(b,a);b.innerHTML='<div class="ec-control '+e.base+'-prev" style="position:absolute;top:0px;left:0px"></div><div class="ec-control '+e.base+'-next" style="position:absolute"></div>';this.$setBody(b.insertBefore(a,b=b.firstChild));this._uPrev=o(w.Popup.Button,b,this,{select:i,focus:i});this._uNext=o(w.Popup.Button,b.nextSibling,this,{select:i,focus:i})}this.$initItems()},k),ch=l(w.Popup.Button=function(b,e){k.call(this,b,e)},k),an=l(w.Popup.Item=function(b,e){w.Item.call(this,b,e);var a=ag(b),c;if(a&&a.tagName=="LABEL"){aj(b,c=y("ec-popup "+e.parent.getBaseClass()));b.appendChild(a);this._cPopup=o(w.Popup,c,this,L({},e))}bS(this)},w.Item),a1,am,ad=l(w.Tab=function(b,e){k.call(this,b,e);var a=y(e.type+"-title "+e.base+"-title","position:relative;overflow:hidden");this._oSelected=e.selected||0;a.innerHTML='<div class="'+e.type+"-title-prev "+e.base+'-title-prev" style="position:absolute;left:0px;display:none"></div><div class="'+e.type+"-title-next "+e.base+'-title-next" style="position:absolute;display:none"></div><div class="'+e.base+'-title-main" style="position:absolute;white-space:nowrap"></div>';aj(b,e=a.lastChild);b.appendChild(a);this.$setBody(e);this.$initItems();this._uNext=o(w.Tab.Button,e=e.previousSibling,this,{select:i});this._uPrev=o(w.Tab.Button,e.previousSibling,this,{select:i})},k),cl=l(w.Tab.Button=function(b,e){k.call(this,b,e)},k),ay=l(w.Tab.Item=function(b,e){w.Item.call(this,b,e);if(b.tagName!="LABEL"){var a=ag(b),c;aj(b,c=y(e.base+"-content"),h);b.appendChild(a);this.setContent(c)}by(b,"display","inline-block");e.parent&&e.selected&&(e.parent._oSelected=this)},w.Item),v=l(w.Edit=function(b,e){var a=b;if(b.tagName=="INPUT"){b=y(a.className,a.style.cssText+";overflow:hidden");a.className="";a.style.cssText="border:0px";ai(b,a).appendChild(a)}else{b.style.overflow="hidden";if(!(a=b.getElementsByTagName("input")[0])){a=ak(j,e.name,e.input);a.value=e.value||"";b.appendChild(a)}a.style.border="0px"}if(this._bHidden=e.hidden)a.style.display="none";by(b,"display","inline-block");this._eInput=a;bG(this);k.call(this,b,e)},k),W={},X=l(w.FormatEdit=function(b,e){w.Edit.call(this,b,e);this._bSymbol=e.symbol!==i;this._bTrim=e.trim!==i;this._sCharset=e.charset;this._oKeyMask=e.keyMask?new RegExp(e.keyMask,"g"):j;this._nMinLength=e.minLength;this._nMaxLength=e.maxLength;this._nMinValue=e.minValue;this._nMaxValue=e.maxValue;this._oFormat=e.format?new RegExp("^"+e.format+"$"):j;this._aSegment=["","",""]},w.Edit),V=l(w.Checkbox=function(b,e){e.hidden=h;e.input="checkbox";w.Edit.call(this,b,e);e.checked&&(this.getInput().checked=h);this._aInferior=[];aZ(this,this.setSuperior,e.superior)},w.Edit),af=l(w.Radio=function(b,e){e.hidden=h;e.input="radio";w.Edit.call(this,b,e);e.checked&&(this.getInput().checked=h)},w.Edit),B=l(w.Tree=function(b,e){var a=ag(b),g=this._aTree=[],c;k.call(this,b,e);this._bFold=i;if(a&&a.tagName=="LABEL"){aj(b,c=y());b.appendChild(a);bX(this,c);for(var d=0,f=T(c);a=f[d];)(g[d++]=bW(a,this,e)).$setParent(this)}e.fold?this.setFold():a5(this)},k),aw=l(w.RadioTree=function(b,e){w.Tree.call(this,b,e);this._sName=e.name;this._sValue=e.value},w.Tree),at=l(w.CheckTree=function(b,e){w.Tree.call(this,b,e);this._oSuperior=e.superior;for(var d=0,a=this._uCheckbox=o(w.Checkbox,b.insertBefore(y("ec-checkbox "+this.getBaseClass()+"-checkbox"),b.firstChild),this,e),f=this.getChildTrees();b=f[d++];)if(e=b._oSuperior){b=b._uCheckbox;e===h?b.setSuperior(a):aZ(b,b.setSuperior,e)}},w.Tree),_=(m.Color=function(a){a?this.setRGB(as(a.slice(0,2),16),as(a.slice(2,4),16),as(a.slice(4),16)):this.setRGB(0,0,0)}).prototype,aP=l(w.Palette=function(b,e){k.call(this,b,e);var d=0,f=['<div class="'+e.base+'-left" style="float:left"><div class="ec-control '+e.base+'-image" style="position:relative;overflow:hidden"><div class="ec-control '+e.base+'-cross" style="position:absolute"><div></div></div></div></div><div class="'+e.base+'-mid" style="float:left"><div class="ec-control '+e.base+'-lightbar" style="position:relative">'];for(;++d<257;)f[d]='<div style="height:1px;overflow:hidden"></div>';f[d++]='<div class="ec-control '+e.base+'-arrow" style="position:absolute"><div></div></div></div></div><div class="'+e.base+'-right" style="float:left"><p>\u57fa\u672c\u989c\u8272</p><div class="'+e.base+'-basic" style="white-space:normal">';for(;d<306;)f[d++]='<div class="ec-control '+e.base+'-area" style="'+(u<8?"display:inline;zoom:1":"display:inline-block")+";background:#"+bM[d-259]+'"></div>';f[d]='</div><table cellspacing="0" cellpadding="0" border="0"><tr><td class="'+e.base+'-color" rowspan="3"><div class="ec-control '+e.base+'-show"></div><input class="ec-edit '+e.base+'-value"></td><th>\u8272\u8c03:</th><td><input class="ec-edit '+e.base+'-edit"></td><th>\u7ea2:</th><td><input class="ec-edit '+e.base+'-edit"></td></tr><tr><th>\u9971\u548c\u5ea6:</th><td><input class="ec-edit '+e.base+'-edit"></td><th>\u7eff:</th><td><input class="ec-edit '+e.base+'-edit"></td></tr><tr><th>\u4eae\u5ea6:</th><td><input class="ec-edit '+e.base+'-edit"></td><th>\u84dd:</th><td><input class="ec-edit '+e.base+'-edit"></td></tr></table><div class="ec-control '+e.base+'-button">\u786e\u5b9a</div><div class="ec-control '+e.base+'-button">\u53d6\u6d88</div></div>';b.innerHTML=f.join("");b=b.firstChild;e=this._uMain=o(w.Palette.Area,f=b.firstChild,this);e._uIcon=o(w.Palette.Area,f.lastChild,e,{capture:i});b=b.nextSibling;e=this._uLightbar=o(w.Palette.Area,f=b.firstChild,this);e._uIcon=o(w.Palette.Area,f.lastChild,e,{capture:i});f=T(b.nextSibling);this._uBasic=o(w.Palette.Collection,f[1],this);b=f[2].getElementsByTagName("td");this._uColor=o(k,b[0].firstChild,this);this._aValue=[];for(d=0;d<7;)this._aValue[d]=o(w.Palette.Edit,b[d].lastChild,this,d++?{keyMask:"[0-9]",maxValue:255}:{keyMask:"[0-9A-Fa-f]",maxLength:6});this._aButton=[o(w.Palette.Button,f[3],this),o(w.Palette.Button,f[4],this)]},k),bL=l(w.Palette.Area=function(b,e){k.call(this,b,e)},k),cg=l(w.Palette.Collection=function(b,e){w.Collection.call(this,b,e)},w.Collection),bN=l(w.Palette.Edit=function(b,e){w.FormatEdit.call(this,b,e)},w.FormatEdit),cf=l(w.Palette.Button=function(b,e){k.call(this,b,e)},k),bM=["FF8080","FFFF80","80FF80","00FF80","80FFFF","0080F0","FF80C0","FF80FF","FF0000","FFFF00","80FF00","00FF40","00FFFF","0080C0","8080C0","FF00FF","804040","FF8040","00FF00","008080","004080","8080FF","800040","FF0080","800000","FF8000","008000","008040","0000FF","0000A0","800080","8000FF","400000","804000","004000","004040","000080","000040","400040","400080","000000","808000","808040","808080","408080","C0C0C0","404040","FFFFFF"],D=l(w.Scroll=function(b,e){k.call(this,b,L(e,{select:i,focus:i}));b.innerHTML='<div class="'+e.type+"-prev "+e.base+'-prev" style="position:absolute;top:0px;left:0px"></div><div class="'+e.type+"-next "+e.base+'-next" style="position:absolute;top:0px;left:0px"></div><div class="'+e.type+"-block "+e.base+'-block" style="position:absolute"></div>';b=T(b);this._nValue=this._nTotal=0;this._nStep=1;this._uPrev=o(w.Scroll.Button,b[0],this,{select:i,focus:i});this._uNext=o(w.Scroll.Button,b[1],this,{select:i,focus:i});this._uBlock=o(w.Scroll.Block,b[2],this,{select:i,focus:i})},k),bj=l(w.Scroll.Block=function(b,e){k.call(this,b,e)},k),a2=l(w.Scroll.Button=function(b,e){k.call(this,b,e)},k),az=l(w.VScroll=function(b,e){w.Scroll.call(this,b,e)},w.Scroll),au=l(w.HScroll=function(b,e){w.Scroll.call(this,b,e)},w.Scroll),aL=function(b,e){k.call(this,b,e);aC(b,"scroll",this.scroll);S(b,"scroll",this.scroll)},z=l(aL,k),bE=function(b,e){aL.call(this,b,e);this._aProperty=["overflowY","scrollTop","height",j,"offsetHeight"]},bD=function(b,e){aL.call(this,b,e);this._aProperty=["overflowX","scrollLeft","width","offsetWidth",j]},bC=P,b9=l(bC,k),M=l(w.Panel=function(b,e){k.call(this,b,e);var d=0,c=e.browser,j=e.vScroll!==i,g=e.hScroll!==i,f=[[j,"_uVScroll",c?bE:w.VScroll],[g,"_uHScroll",c?bD:w.HScroll],[j&&g,"_uCorner",c?bC:k]],a=y(e.base+"-main","position:absolute;top:0px;left:0px"+(g?";white-space:nowrap":""));b.style.overflow="hidden";aj(b,a,h);b.innerHTML=(c?'<div style="position:absolute;top:0px;left:0px;overflow:auto;padding:0px;border:0px"><div style="width:1px;height:1px;padding:0px;border:0px"></div></div>':(j?'<div class="ec-vscroll '+e.base+'-vscroll" style="position:absolute"></div>':"")+(g?'<div class="ec-hscroll '+e.base+'-hscroll" style="position:absolute"></div>':"")+(j&&g?'<div class="'+e.type+"-corner "+e.base+'-corner" style="position:absolute"></div>':""))+'<div class="'+e.base+'-layout" style="position:relative;overflow:hidden"></div>';this.$setBody(b.lastChild.appendChild(a));this._bAbsolute=e.absolute;this._nWheelDelta=e.wheelDelta;b=b.firstChild;c&&(this._eBrowser=b);for(;a=f[d++];)if(a[0]){this[a[1]]=o(a[2],b,this);c||(b=b.nextSibling)}},k),av=l(w.Listbox=function(b,e){e.hScroll=i;w.Panel.call(this,b,e);this._sName=e.name||"";this.$initItems()},w.Panel),ae=l(w.Listbox.Item=function(b,e){w.Item.call(this,b,e);b.appendChild(this._eInput=ak(j,e.parent._sName,"hidden")).value=e.value===p?br(b):e.value;this.setSelected(!(!e.selected))},w.Item),C=l(w.Select=function(b,e){e.hidden=h;var d=0,f=[],j=b.name||e.name||"",l=b.value||e.value||"",g=b.options,c=y("ec-panel "+e.base+"-options","position:absolute;z-index:65535;display:none"),a=b;if(g){b=ai(y(b.className,b.style.cssText),b);K(a);for(;a=g[d];)f[d++]="<div "+b1()+'="value:'+cn(a.value)+'">'+a.text+"</div>";c.innerHTML=f.join("")}else aj(b,c);b.innerHTML='<div class="ec-item '+e.base+'-text"></div><div class="ec-control '+e.base+'-button" style="position:absolute"></div><input name="'+j+'">';w.Edit.call(this,b,e);this._uOptions=o(w.Select.Options,c,this,{hScroll:i,browser:e.browser});this.$setBody(c);b=T(b);this._uText=o(w.Item,b[0],this,{capture:i});this._uButton=o(k,b[1],this,{capture:i});b[2].value=l;this._nOptionSize=e.optionSize||5;this.$initItems()},w.Edit),cj=l(w.Select.Options=function(b,e){w.Panel.call(this,b,e)},w.Panel),bl=l(w.Select.Item=function(b,e){w.Item.call(this,b,e);this._sValue=e.value===p?br(b):""+e.value},w.Item),cb=l(w.Combox=function(b,e){w.Select.call(this,b,e);this.getInput().style.display="";this.$getSection("Text").getOuter().style.display="none"},w.Select),I=l(w.MultiSelect=function(b,e){w.Select.call(this,b,e);K(this.getInput())},w.Edit),a0=l(w.MultiSelect.Item=function(b,e){w.Select.Item.call(this,b,e);b=this._eInput=e.parent.getBase().appendChild(ak(j,e.parent.getName(),"checkbox"));b.value=e.value||"";b.style.display="none"},w.Select.Item),A=l(w.Table=function(b,e){var d=0,h=this._aRow=[],r=this._aCol=[],m=ag(b),f=T(m),g=f[0],c,a;K(m);e.wheelDelta=1;w.Panel.call(this,b,e);if(g.tagName!="THEAD"){b=ai(y("","","thead"),g).appendChild((f=T(g)).shift());g=s(b)}else{f=T(f[1]);b=cp(g)}m.setAttribute("cellSpacing","0");if(a=this.$getSection("VScroll"))a.setValue=bV;if(a=this.$getSection("HScroll"))a.setValue=bV;a=y(e.type+"-area "+e.base+"-area","position:absolute;top:0px;overflow:hidden");a.innerHTML='<div style="white-space:nowrap;position:absolute"><table cellspacing="0"><tbody></tbody></table></div>';(this._uHead=o(k,this.getBase().appendChild(a),this)).$setBody(b);for(c=aR(this,"Row");a=f[d];d++){a.className=e.type+"-row "+(aH(a.className)||e.base+"-row");f[d]=ag(a);(h[d]=o(c,a,this))._aCol=[]}for(d=0,g=T(b);g[d];d++)for(c=0;h[c];c++){a=f[c];if(h[c]._aCol[d]===p){h[c]._aCol[d]=a;f[c]=cq(a);var l=n(a.getAttribute("rowSpan"))||1,q=n(a.getAttribute("colSpan"))||1;while(l--){l||q--;for(a=q;a--;)h[c+l]._aCol.push(l?i:j)}}}for(d=0;b=g[d];d++){a=b.className.split(/\s+/);a=a[0]||a[1]||e.base;b.className=e.type+"-head "+(aH(b.className)||a+"-head");r[d]=o(w.Table.Col,b,this);for(c=0;f=h[c];c++)if(b=f._aCol[d]){b.className=e.type+"-item "+(aH(b.className)||a+"-item");b.getControl=u==8?ax():ax}}this.getBody().appendChild(m)},w.Panel),ao=l(w.Table.Row=function(b,e){
...
k.call(this,b,e)},k),ax=u==8?function(){
...
for(d=0,f=T(b.lastChild.lastChild);a=f[d];)h[d]=bJ(this,a,g[d++]);
...
R=aD.Decorator=function(b,c,f){



var d=b.getUID(),a=(this._oInner=R[d]||b).getOuter();
...
ba(this._eOuter,"BEFOREEND",f.join(""))}},H=R.prototype,aI={},
...
b6=aD.LRDecorator=function(a,b){

R.call(this,a,b,["left","right"])},
...
b8=aD.TBDecorator=function(a,b){

R.call(this,a,b,["top","bottom"])},
...
b7=aD.MagicDecorator=function(a,b){

R.call(this,a,b,["widget0","widget1","widget2","widget3","widget5","widget6","widget7","widget8"])},
...
var e=aa[this.getUID()],d=e.start,b=e.end=g(this),k=i,j;for(j in d)d[j]!=b[j]&&(k=h);if(k){
...
(function(){
var X="ecui",ag,R,_,ak,M=0,aj,ab={},N=[],D,E,I=0,B,O=[],aa=[],H,al=0,W={},A,r,V,z,ad=[],l={mousedown:function(c){
...
var a=c.getTarget();
r=j;if(a){if(ai(c)){if(u<8)return}else T(a,c);
...
break}}else(a=Q(c.target))?T(a,c,h):ar()},mouseover:function(c){
...
var a=c.getTarget(),d=ae(a,V),b=l.type;
...
C(V,"mouseout",c,d);b&&r.contain(V)&&r.pressout(c);
...
var a=l.target,d=l,b=c.getTarget();ai(c)||(b&&!b.isFocusable()?T(b,c):a.onintercept&&a.onintercept(c)===i||a.$intercept(c)===i?d==l?b&&T(b,c):l.mousedown(c):aq())}},J={type:"zoom",mousemove:function(c){
...
B=bB;
a=l.type;
U(i);if(a!="zoom"){a=="drag"&&l.mouseup();
...
b=a.getBase();
b.style.width=b.offsetWidth-(R?a.getInvalidWidth(h)*2:0)+"px"}
...
for(d=0;a=f[d++];)a.$setSize(a.getWidth(),a.getHeight())}u<8?Z(U,0,j,h):U(h);
...
aY=m.$bind=function(b,a){if(!b.getControl){
...
aZ=m.$connect=function(a,b,c){if(c){
...
c=new w[bz(c.charAt(0).toUpperCase()+c.slice(1))](b,e);e.parent?c.setParent(e.parent):(a=Q(s(c.getOuter())))?a.onappend&&a.onappend(c)===i||a.$append(c)===i||c.$setParent(a):c.$setParent();
...
o=m.$fastCreate=function(c,b,d,e){M||(B=a$);
...
return R?n(a.borderTopWidth)+n(a.borderBottomWidth)+n(a.paddingTop)+n(a.paddingBottom):0};
...
return!ap||a.overflow!="visible"&&F(b,"position")=="absolute"?n(a.borderLeftWidth)*_:0};
...
var a=F(b.offsetParent);
return!ap||a.overflow!="visible"&&F(b,"position")=="absolute"?n(a.borderTopWidth)*_:0};
...
return R?n(a.borderLeftWidth)+n(a.borderRightWidth)+n(a.paddingLeft)+n(a.paddingRight):0};
...
cm=m.create=function(a,e){M||(B=a$);
...
var d=0,e=b instanceof k,c={},a;e?aW(b):z&&b0(b,z.getOuter())&&ar(Q(s(b)));for(a in H)c[H[a].getUID()]=a;
...
for(;a=O[d++];)if(e?b.contain(a):b0(b,a.getOuter())){

a.dispose();
aX(aa,a);(a=c[a.getUID()])&&delete H[a];
...
L(v,e.tagName=="BODY"||e.tagName=="HTML"?aF():{top:0,right:e.offsetWidth-n(f.borderLeftWidth)-n(f.borderRightWidth),bottom:e.offsetHeight-n(f.borderTopWidth)-n(f.borderBottomWidth),left:0});
...
m.get=function(b){if(!H){for(a in l)S(t,a,l[a]);
...
var a=aU(t.body,"data-ecui");


X=a.name||X;
ag=a.globalId;

ba(t.body,"BEFOREEND",'<div style="position:absolute;overflow:scroll;top:-90px;left:-90px;width:80px;height:80px;border:1px solid"><div style="position:absolute;top:0px;height:90px"></div></div>');
...
aS=m.getMouseX=function(a){if(a){
...
aT=m.getMouseY=function(a){if(a){
...
aU=m.getParameters=function(b,a){
a=a||X;

var c=b.getAttribute(a),e={};if(c)for(b.removeAttribute(a);/\s*([\w-]+)\s*(:\s*|:\s*([^;]+)\s*)?($|;)/.test(c);){
...
m.init=function(b){
var d=0,f=[],e=b.all||b.getElementsByTagName("*"),c=[b],a;if(!M++){
...
e=aU(b);
e.element=b;(b=e.type)&&f.push(b=bb(b,e));for(a in ab){e[a]&&ab[a](b,e[a]);
...
aW=m.loseFocus=function(a){a.contain(z)&&ar(a.getParent())};
...
U=m.mask=function(b,c){

var d=0,a=aF(),g=q(a.top-a.height*2,0),f=q(a.left-a.width*2,0),e=";top:"+g+"px;left:"+f+"px;width:"+x(a.width*5,a.maxWidth-f)+"px;height:"+x(a.height*5,a.maxHeight-g)+"px;display:";if("boolean"==typeof b){
...
e+=b?"block":"none";
for(;a=N[d++];)a.style.cssText+=e}else if(b===p){




K(N.pop());N.length||bx(t.body,"mask")}else{N.length||bo(t.body,"mask");
...
N.push(a=t.body.appendChild(y("","position:absolute;background-color:#000;z-index:"+(c||32767))));
...
ba(t.body,"BEFOREEND",'<div class="ec-control ec-selector" style="overflow:hidden"><div class="ec-selector-box"></div></div>');
...
a.getOuter().style.position="absolute";b&&L(J,b);
...
J.left=a.getX();
J.width=a.getWidth();
J.height=a.getHeight();
J.target=a;
ac(J);u&&t.body.setCapture();a.onzoomstart&&a.onzoomstart(c)===i||a.$zoomstart(c)}};
...
l[ap?"DOMMouseScroll":"mousewheel"]=function(c){
c=G(c);c.detail===p&&(c.detail=c.wheelDelta/-40);(l.type=="drag"||C(V,"mousewheel",c)===i||C(z,"mousewheel",c)===i)&&c.preventDefault()};
...
function an(){
var a=Q(this.target);if(a&&a.isEnabled()){for(;a;a=a.getParent())if(a.isCapture())return a};
...
function as(){
for(var d=0,a;a=O[d++];)try{a.dispose()}catch(b){}
...
function $(b,c){
for(var d=0,e=c?aC:S,a;d<5;)b[a=aQ[d++]]&&e(t,a,b[a])}
...
for(var 
d=0,f=["borderTopWidth","borderLeftWidth","borderRightWidth","borderBottomWidth","paddingTop","paddingLeft","paddingRight","paddingBottom"],b=this._eBase,g=aV(),a;a=f[d++];)this["$cache$"+a]=n(c[a]);
...
this.$setSize(this.getWidth(),this.getHeight());if(this.$ready)if(bq()!=a$)this.$ready();else{if(!aN){
...
b.style.width=this._sWidth;if(u<8&&bq()!=bB){


var a=F(b);if(a.width=="auto"&&a.display=="block"){

b.style.width="100%";
b.style.width=b.offsetWidth-(aV()?this.getInvalidWidth(h)*2:0)+"px"}}
...
(b?bx:bo)(this._eBase,this._sType+a+this._sClass+a);b?aX(this._aStatus,a):this._aStatus.push(a)};
...
this.alterClass("disabled",a);a||aW(this);
...
c=a;
a=Q(a)}if(a!=d||c!=s(b)){if(d){d.onremove&&d.onremove(this);
...
for(var d=0,a;a=aQ[d++];)b(a,d>17||d==10);




g.$intercept=g.$append=g.$remove=g.$selectstart=g.$select=g.$selectend=g.$zoomstart=g.$zoom=g.$zoomend=g.$dragstart=g.$dragmove=g.$dragend=P})();
...
bi.setText=function(a,b){
a=x(q(0,a),1);b!==p&&(this._eText.innerHTML=this._eMask.innerHTML=b||aK(a*100)+"%");
...
var d=J(aO,this),a;if(this.getOuter().style.zIndex<32768){




aO.push(aO.splice(d,1)[0]);
for(;a=aO[d++];)a.getOuter().style.zIndex=4095+d}};
...
ab.$hide=function(){
g.$hide.call(this);this.getOuter().style.zIndex==32768&&U()};
...
a=aF(),b=a.right+a.left,c=a.bottom+a.top;else{
...
var d=aB.caller,c=e(a.constructor.prototype,d);c===p&&(c=e(a.constructor.prototype,d.caller));if(c)return c.apply(a,d["arguments"])}
...
r.$append=function(a){if(!(a instanceof(aR(this,"Item")||w.Item))||aB(this,"$append")===i)return i;
...
for(var d=0,f=T(this.getBody()),a;a=f[d++];)this.add(a);
...
b.className="ec-item "+(aH(b.className)||this.getBaseClass()+"-item");

e=e||aU(b);
e.parent=this;
e.select=i;
f.push(b=o(aR(this,"Item")||w.Item,b,this,e));
...
an.$click=function(c){
O.$click.call(this,c);this.getItems().length||a1.hide()};
...
an.$mouseout=function(c){
O.$mouseout.call(this,c);this.getItems().length||this.getParent().$setActived()};
...
an.$mouseover=function(c){

O.$mouseover.call(this,c);

var a=aF(),e=this._cPopup,f=this.getParent(),i=f._cSuperior,b=f._cInferior,h=ah(this.getOuter()),d=h.left,g;if(b!=e){b&&b.hide();if(this.getItems().length){
...
an.$pressend=function(c){
O.$pressend.call(this,c);this.contain(c.getTarget())||a1.hide()};
...
this.$setActived();(am=this._cSuperior)?(am._cInferior=j):aq()};
...
Y.$intercept=function(c){Q(c.target) instanceof w.Popup.Item||a1.hide();
...
var a=aF(),b=this.getOuter(),c;if(!s(b)){
...
this.setPosition(x(q(c.left,a.left),a.right-this.getWidth()),x(q(c.top,a.top),a.bottom-this.getHeight()));if(am){
...
b.style.zIndex=n(F(am.getOuter(),"zIndex"))+1;
this._cSuperior=am;
am._cInferior=this}else{
...
Y.cache=function(a,b){s(this.getOuter())&&g.cache.call(this,a,b)};
...
Y.paint=function(){s(this.getOuter())&&g.paint.call(this)};
...
ay.$cache=function(a,b){
O.$cache.call(this,a,b);
...
ay.$setParent=function(a){

var b=this._eContent;

O.$setParent.call(this,a);b&&(a?a.getBase().appendChild(b):K(b))};
...
function bG(a){if(aY(a._eInput,a)){if(!a._bHidden)for(var b in W)S(a._eInput,b,W[b])}}
...
W.blur=W.focus=function(c){



c=Q(G(c).target);

c["$"+c.type]=g["$"+c.type];c.type=="blur"?c.isEnabled()&&aW(c):c.isEnabled()?ar(c):c._eInput.blur();
...
W.dragover=W.drop=function(c){
c=G(c);
c.stopPropagation();
c.preventDefault()};u?(W.propertychange=function(c){c.propertyName=="value"&&Q(G(c).target).change()}):W.input=function(){
...
this._eInput=ak(this._eInput,a||"");
bG(this)};
...
var b=W.propertychange;b&&aC(this._eInput,"propertychange",b);




this._eInput.value=a;b&&S(this._eInput,"propertychange",b)};
...
aC(this._eInput,a,W.blur);try{this._eInput[a]()}catch(b){}





S(this._eInput,a,W.blur)},0,this)}}
...
X.$keydown=X.$mousemove=function(c){
...
var a={},b=this.getValue(),c=b2(b,this._sCharset);this._nMinLength>c&&(a.minLength=this._nMinLength);this._nMaxLength<c&&(a.maxLength=this._nMaxLength);this._nMinValue>+b&&(a.minValue=this._nMinValue);this._nMaxValue<+b&&(a.maxValue=this._nMaxValue);this._oFormat&&!this._oFormat.test(b)&&(a.format=h);(b=!a.length)||this.onerror&&this.onerror(a);
...
function bd(a,b){if(b!==a._nStatus){


a.setClass(a.getBaseClass()+["-checked","","-part"][b]);

a._nStatus=b;
a.getInput().checked=!b;a._cSuperior&&be(a._cSuperior);
...
V.$keydown=V.$keypress=V.$keyup=function(c){
v["$"+c.type].call(this,c);if(c.which==32){c.type=="keyup"&&aE()==32&&this.setChecked(!(!this._nStatus));
...
V.$ready=function(){this._aInferior.length||bd(this,this.getInput().checked?0:1)};
...
V.$setParent=function(a){
v.$setParent.call(this,a);a||this.setSuperior()};
...
v["$"+c.type].call(this,c);if(c.which==32){c.type=="keyup"&&aE()==32&&this.checked();
...
function bW(b,a,e){
b.className=a.getType()+" "+(aH(b.className)||a.getBaseClass());
return o(a.constructor,b,j,L(L({},e),aU(b)))}
...
function ci(a,b){
a.getBody().appendChild(a._eInput=ak(b,a._sName,"hidden"));
...
aw.$click=function(c){if(aS(this)<=n(F(this.getBase(),"paddingLeft"))){
...
this._aValue=[bc(e,d,a+.3333333333333333),bc(e,d,a),bc(e,d,a-.3333333333333333),a,b,c]};
...
function bP(a,b,c){
for(var d=0,f=T(a._uLightbar.getBody()),e=new m.Color();d<256;){
...
bh(a,[b.getRGB(),p,b.getRed(),p,b.getGreen(),p,b.getBlue()])}
...
bh(a,[b.getRGB(),aK(b.getHue()*256)%256,p,aK(b.getSaturation()*255),p,aK(b.getLight()*255)]);
...
var a=this._uIcon,d,e=aT(this),b={top:0,bottom:255+a.getHeight()};if(this==this.getParent()._uMain){
...
X.$keydown.call(this,c);

var e=this.getParent(),b=this.getValue(),f=this.getSelectionStart(),d=this.getSelectionEnd(),a=aE();if(!c.ctrlKey&&this==e._aValue[0]){if(a==46||a==8)c.preventDefault();else if(a!=37&&a!=39){f==d&&d++;
...
aP.setColor=function(a){
bh(this,[p,p,a.getRed(),p,a.getGreen(),p,a.getBlue()]);
...
g[c.type=="mouseout"?"$pressout":"$pressend"].call(this,c);
...
g[c.type=="mouseover"?"$pressover":"$pressstart"].call(this,c);
bk(this,q(this.getParent()._nStep,5))};
...
g[c.type=="mouseover"?"$pressover":"$pressstart"].call(this,c);
bk(c.type=="mouseover"?this._cButton:this._cButton=this.$allowPrev()?this._uPrev:this._uNext,this.$getPageStep())};
...
az.$allowNext=function(){
return aT(this)>this._uBlock.getY()+this._uBlock.getHeight()};
...
az.$allowPrev=function(){
return aT(this)<this._uBlock.getY()};
...
au.$allowNext=function(){
return aS(this)>this._uBlock.getX()+this._uBlock.getWidth()};
...
au.$allowPrev=function(){
return aS(this)<this._uBlock.getX()};
...
return this._aProperty[4]?this.getBase()[this._aProperty[4]]:bp()};
...
z.getWidth=function(){
return this._aProperty[3]?this.getBase()[this._aProperty[3]]:bp()};
...
z.scroll=function(c){
c=Q(G(c).target).getParent();c.onscroll&&c.onscroll()===i||c.$scroll()};
...
z.$cache=z.$getPageStep=z.$init=z.$setPageStep=z.$setSize=z.alterClass=z.cache=z.getStep=z.setPosition=z.setStep=z.skip=P;
...
(function(){for(var a in g)b9[a]=P})();
...
var a=aE(),b=a%2?this._uHScroll:this._uVScroll;if(a>=37&&a<=40&&!c.target.value){b&&b.skip(a+a%2-39);
...
function bf(b){
var d=b.getParent(),e=d.$getSection("VScroll"),f=e.getStep(),a=aT(d),c=b._nTop;
...
var a=bf(this),f=this.getParent().getItems(),b=this._nLast,c=0,e=-1,d=0,g=-1;if(a>b)if(a<this._nStart){
...
var a=bf(this),f=this.getParent().getItems(),b=this._nStart,c=x(b,a),d=q(b,a);if(b==a)this.setSelected(!this.isSelected());else for(;c<=d;)f[c++].setSelected()};
...
this._nStart=this._nLast=bf(this);
this.alterClass("selected")};
...
O.$setParent.call(this,a);a instanceof w.Listbox&&(this._eInput=ak(this._eInput,a._sName))};
...
av.setName=function(b){
for(var d=0,f=this.getItems(),a;a=f[d++];)a._eInput=ak(a._eInput,b);
...
a._uOptions.setPosition(c.left,d+a<=aF().bottom?d:c.top-a)}}
...
var a=Q(c.target);
this._uOptions.hide();
U();if(a instanceof w.Select.Item&&a!=this._cSelected){
...
this.getBase().appendChild(ak(a._eInput,this.getName()))};
...
I.$intercept=function(c){if(Q(c.target) instanceof w.MultiSelect.Item)return i;
...
var a=aE();if(a==13||a==32){if(c.type=="keyup"){
...
K(a);a.getControl!=ax&&a8(a.getControl())}
...
e.getBody().insertBefore(a,c);a.getControl!=ax&&a.getControl().$setParent(e)}}
...
function ce(b){
bg(b._uLockedHead);
for(var d=0,a;a=b._aLockedRow[d++];)bg(a)}
...
var e=g.getInvalidWidth.call(this),d=g.getInvalidHeight.call(this),c=aV();
...
(b?bx:bo)(this._eOuter,this._sClass+"-"+a);
...
aI.clear=function(){for(a in aI)delete this[a];





var b=this.getUID(),a=R[b];
...
function c(b,c){
aI[b]=function(){
var a=R[this.getUID()],d=arguments;
...
c=aD[bz(c.charAt(0).toUpperCase()+c.slice(1))];
