    ...
    */
    ECOM_CALENDAR_CLASS.showRange = function() {
        var range = ECOM_CALENDAR_PARSERANGE(this.$cal$range), 
            ...
            dayCount = new Date(year, month + 1, 0).getDate(),  // 本月的天数
     ...
     * 基本日历输入框
     * 元件
     * _uCalendar {Control} 日历
     * _uEdit {HTMLElement} 输入框
     * _uClear {Control}    清除按钮
     */
    var ECOM_CALENDAR_EDIT_CREATEDCALS = {},
        ...
        clear.onclick = ECOM_CALENDAR_EDIT_CLEARCLICK;
     ...
     * 依赖于外挂日历上绑定的方法
     */
    ECOM_CALENDAR_EDIT_CLASS.setValue = function() {
        var fn = this._uCalendar.setEditValue;
     ...
     * 清除日历已选数据
     */
    ECOM_CALENDAR_EDIT_CLASS.clearValue = function() {
        var fn = this._uCalendar.clearEditValue;
        fn && fn.call(this);
    };
...
//        core.mask();
     ...
     * 点击清除按钮
     */
    function ECOM_CALENDAR_EDIT_CLEARCLICK() {
...
//        core.mask();
     ...
     * @public
     */
    ECOM_CALEDIT_SINGLECAL_CLASS.setEditValue = function (value) {
        // this为日历输入框
        var value = trim(value),
            tmpDate = parseDate(value);
        if (tmpDate.constructor !== Date || !datePattern.test(value) && value != "") {
            throw new Error("日期格式错误!");
            return;
        }
        else {
            this._uEdit.value = value;
            this._uCalendar.hide();
        }
    };

    ECOM_CALEDIT_SINGLECAL_CLASS.clearEditValue = function() {
        ECOM_CALEDIT_SINGLECAL_CLASS.setEditValue.call(this, "");
    };
    ...
    var ECOM_CALEDIT_RANGECAL = ECOM_CALENDAR_EDIT.Range = function(el, params) {
        ...
        body.innerHTML = '<div class="time-begin"><table><tr>\
            ...
            <button>确定</button><button>取消</button><button style="display:none">重选</button><span class="calendar-error"></span>';
    ...
    */
    ...
    function ECOM_CALEDIT_RANGECAL_CONFIRMCLICK(event) {
        ...
        if (valid) {
            ...
            beginVal = wrapper._cWrapper._uBeginInput.value 
                = wrapper._uBeginCal.$cal$selectedDate ? formatDate(wrapper._uBeginCal.$cal$selectedDate, ECOM_CALENDAR_DATEFORMAT) : "";
            endVal = wrapper._cWrapper._uEndInput.value 
                = wrapper._uEndCal.$cal$selectedDate ? formatDate(wrapper._uEndCal.$cal$selectedDate, ECOM_CALENDAR_DATEFORMAT) : "";
     ...
     * @public
     */
    ECOM_CALEDIT_RANGECAL_CLASS.setEditValue = function (bValue, eValue) {
        // this为日历输入框
        var inputNames = ["Begin", "End"],
            valueObj = {};

        for (var i = 0, o; o = inputNames[i]; i++) {
            ...
            if (tmpDate.constructor !== Date || !datePattern.test(value) && value != "") {
                ...
                this["_u" + o + "Input"].value = value;
                this._uCalendar.hide();
                valueObj[o.toLowerCase()] = value;
            }
        }

        ECOM_CALEDIT_RANGECAL_WRITEDATE(this._uEdit, valueObj.begin, valueObj.end);
    };
     ...
     * @public
     */
    ECOM_CALEDIT_RANGECAL_CLASS.clearEditValue = function () {
        var initCalProps = this._oInitCalProps;

        ECOM_CALEDIT_RANGECAL_CLASS.setEditValue.call(this, "", "");

        initCalProps._oBeginProps.range = this._sRange;
        initCalProps._oEndProps.range = this._sRange;
    };
