...
(function() {
	...
	UI_MULTISELECT = ecomui.MultiSelect = ui.MultiSelect = function(el, params) {
        ...
        wrapper.innerHTML = '<div class="ec-control' + typeClass
            ...
            + '-button" style="position:absolute"></div><input readonly="readonly"/>';
    ...
    UI_MULTISELECT_CLASS.$setSize = function(width, height) {
        ...
        // this._eInput.style.width = getStyle(this.getOuter(), "width");
        listBox.setSize(width, 
                items[0] ? Math.min(len, this._nSize) * items[0]._nHeight : height);
