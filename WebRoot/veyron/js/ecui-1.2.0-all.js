    ...
    var UI_TREE =
        ui.Tree = function (el, params) {
            ...
            if (o && o.tagName == 'LABEL') {
                ...
                this._bFold = el.style.display == 'hidden';
            ...
            if (pressStep) {
                ...
                object.$pressstart = function (event) {
                    ...
                    if (params.startValue != params.endValue) {
                        params.currTime = 0;
                        steady.call(this);
                        params.timer = timer(steady, -40, this);
                    }
                ...
                object.$pressend = function (event) {
                    ...
                    params.timer = timer(decelerate, -20, this);
...
*/
    ...
    UI_ITEMS.add = function (item, index, params) {
        ...
        if (item instanceof UI_ITEM) {
            ...
            item.className = 'ec-item ' + (trim(item.className) || this.getClass() + '-item');
